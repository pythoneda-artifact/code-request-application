...
class PythonedaContext(PythonEDA):
    ...
    def __init__(self):
        ...
        try:
            from pythoneda.artifact.code_request.application.code_request_banner import CodeRequestBanner
...
if __name__ == "__main__":
    asyncio.run(PythonedaContext.main("pythoneda.artifact.code_request.application.PythonedaContext"))
